...
function guessNumber(){
	...
	while(gameIsRunning){
		...
		//вывод истории
            ...
            var n;
            n = prompt("Введите номер хода");
            alert("На " + n + " ходу вы ввели: " + turn[n]);
            result = prompt("Быки: " + answer[1] + " Коровы: " + answer[2] + " Введите число (-1 - закончить игру, -2 - посмотреть предидущие ходы)", 0);
        }
        // проверяем число
		else{
            turn.push(result);
